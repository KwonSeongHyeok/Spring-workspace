...
@Controller // 요청하거나 응답제어 역할을 명시 Bean 등록 Bean = Spring에서 어떤 기능을 하라 설정해놓은 
...
public class ExampleController {
	...
	public String ex1(HttpServletRequest req, Model model) {
		...
		req.setAttribute("test1", "HttpSerbletRequest로 전달한 값");
		...
		mem.setMemberNo("123456");
		mem.setMemberName("김세모");
		mem.setMemberAge(30);
		...
		// List<MemberDTO> 객체에 Model을 이용해서 html 전달
	...
	public String ex4(Model model) {
		// 아직 std 전달해준 값이 없기때문에 th:unless 안에 작성해준
		// std 없음이 뜨는 것이 정상
		...
		// num 100 값을 주고
		// <h4 th:case="100">AAAAAAAAAA</h4> 출력
