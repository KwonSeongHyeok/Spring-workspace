...
// @RequiredArgsConstructor는 @Autowired와 같지만 내부에서 하나씩 해주는 것이 아니라 외부에서 전체적으로 설정
...
public class EmailService {
	...
	// 이메일을 보낼 때 보내는 이 내용 받는이
	private final JavaMailSender javaMailSender;
	
	// 이메일을 보낼 이메일 주소값
	private static final String senderEmail = "aiqksiwk@gmail.com"; // 이메일을 보낼 담당자 이메일 작성
	 ...
	 * Math.random()에 (90000) 곱하기를 해주면 0.0 부터 89999999.99999 사이의 값을 반환
	 * 정수의 경우에는 맨 앞자리나 001 0이 아닌 수가 나오기 전까지는 모두 0이면
	 * 001 -> 1로 변하는 마법
	 * 01055556666 -> 1055556666
	 * 100000부터 189999 사이의 임의의 6자리 숫자를 생성
	 * 
	 * 만약에 5자리 원하면
