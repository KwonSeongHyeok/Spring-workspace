...
public class IndexController {
	...
	@GetMapping("/") // index는 기본 주소가 / 임  특별히 특정한 기능을 넣지 않으면
	...
	public String getAllSC(Model model) {
		...
		/*
		 모든 db값 가져오는지 확인하기[com.khmall.dto.SC@72092b72, com.khmall.dto.SC@2c873214, com.khmall.dto.SC@6d50334a, com.khmall.dto.SC@56d714e3]
		 
		 DTO에서 @ToString을 이용하지 않으면 DB에서 가져오는 주소값만 보여주기 때문에
		 값을 제대로 가지고 왔는지 확인하길 원한다면 DTO에서 @ToString 추가
		 
		 만약에 값을 제대로 가져오지 못하면 null이 뜰 것
		 * 
		 * */
